...
CREATE TABLE PHONE_NUMBER_COMPAIGN(
	ID_CLIENT_CAMPAIGN NUMBER(10) GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
...
CREATE TABLE INVOICE(
	...
	ID_PHONE_NUMBER_CONTRACT NUMBER(10),
	ID_CLIENT NUMBER(10),
	ID_INVOICE_SMS NUMBER(10),
	ID_INVOICE_CALL NUMBER(10),
	INVOICE_DATE DATE DEFAULT SYSDATE,
	VALUE NUMBER(10),
	CONSTRAINT FK_INVOICE_ID_SMS
	FOREIGN KEY (ID_INVOICE_SMS) REFERENCES INVOICE_SMS(ID_INVOICE_SMS),
	CONSTRAINT FK_INVOICE_ID_CLIENT
	FOREIGN KEY (ID_CLIENT) REFERENCES CLIENT(ID_CLIENT),
	CONSTRAINT FK_INVOICE_ID_PHONE_NUMBER_CONTRACT
	FOREIGN KEY (ID_PHONE_NUMBER_CONTRACT) REFERENCES PHONE_NUMBER_CONTRACT(ID_PHONE_NUMBER_CONTRACT),
	CONSTRAINT FK_INVOICE_ID_INVOICE_CALL
	FOREIGN KEY (ID_INVOICE_CALL) REFERENCES INVOICE_CALL(ID_INVOICE_CALL)
)

CREATE TABLE INVOICE_RELLATION(
	ID_INVOICE_RELLATION NUMBER(10) GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
	ID_INVOICE NUMBER(10),
	ID_INVOICE_SMS NUMBER(10) DEFAULT NULL,
	ID_INVOICE_CALL NUMBER(10) DEFAULT NULL,
	CONSTRAINT FK_INVOICE_RELLATION_ID_INVOICE
	FOREIGN KEY (ID_INVOICE) REFERENCES INVOICE(ID_INVOICE),
	CONSTRAINT FK_INVOICE_RELLATION_ID_INVOICE_SMS
	FOREIGN KEY (ID_INVOICE_SMS) REFERENCES INVOICE_SMS(ID_INVOICE_SMS),
	CONSTRAINT FK_INVOICE_RELLATION_ID_INVOICE_CALL
	FOREIGN KEY (ID_INVOICE_CALL) REFERENCES INVOICE_CALL(ID_INVOICE_CALL)
)
